    ...
    : m_bounds(0, 0, 0, 0)
{
    ...
    m_pack_type = static_cast<graphite::qd::pack_type>(px_reader.read_signed_short());
...
auto graphite::qd::pixmap::pack_type() const -> enum graphite::qd::pack_type
{
    return m_pack_type;
}

auto graphite::qd::pixmap::set_pack_type(const enum graphite::qd::pack_type& pack_type) -> void
{
...
auto graphite::qd::pixmap::pixel_type() const -> enum graphite::qd::pixel_type
{
    return m_pixel_type;
}

auto graphite::qd::pixmap::set_pixel_type(const enum graphite::qd::pixel_type& pixel_type) -> void
{
...
auto graphite::qd::pixmap::plane_bytes() const -> uint32_t
{
    return m_plane_bytes;
}
...
auto graphite::qd::pixmap::write(graphite::data::writer& writer, bool with_base_address) -> void
{
    ...
    writer.write_signed_short(static_cast<int16_t>(m_pack_type));
